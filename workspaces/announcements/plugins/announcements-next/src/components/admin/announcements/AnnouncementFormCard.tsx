...
type AnnouncementFormCardProps = {
  initialData: Announcement;
  onSubmit: (data: CreateAnnouncementRequest) => Promise<void>;
};

/**
 * Wrapper component that displays AnnouncementForm within a Card.
 * Use this when displaying the form on a page. For modals, use
 * AnnouncementForm directly.
 */
export const AnnouncementFormCard = (props: AnnouncementFormCardProps) => {
