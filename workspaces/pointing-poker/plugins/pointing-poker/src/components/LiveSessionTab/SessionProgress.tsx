...
const STATE_STYLE: Record<StoryState, StateStyle> = {
  active: {
    dot: 'var(--bui-fg-announcement)',
    label: 'now',
    tag: 'var(--bui-fg-announcement)',
  },
  estimated: {
    dot: 'var(--bui-fg-positive)',
    label: 'done',
    tag: 'var(--bui-fg-positive)',
  },
  pending: {
    dot: 'transparent',
    dotBorder: true,
  ...
  skipped: {
    dot: 'var(--bui-fg-negative)',
    label: 'skipped',
    tag: 'var(--bui-fg-negative)',
  },
  snoozed: {
    ...
    >
      ...
      {splitParent && (
        <Text
          ...
          variant="body-small"
          weight="bold"
          style={{ color: 'var(--bui-fg-announcement)' }}
        >
