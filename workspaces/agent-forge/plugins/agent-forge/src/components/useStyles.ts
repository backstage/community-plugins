...
const useStyles = makeStyles(_ => ({
  ...
  lightMode: {
    ...
    '--bot-response': '#f8f9fa',
    '--user-response': '#e3f2fd',
    '--greeting-text-color': '#212121',
    '--tab-bg': '#ffffff',
    '--tab-text': '#3A9BFF',
    '--tab-hover-bg': 'linear-gradient(to right, #3A9BFF, #2E7CE8)',
    '--tab-hover-text': '#ffffff',
    '--tab-outline': '#3A9BFF',
    '--assistant-message-bg': '#3A9BFF',
    '--assistant-message-text': '#ffffff',
    '--feedback-button-bg': 'linear-gradient(to right, #3A9BFF, #2E7CE8)',
    '--feedback-button-text': '#ffffff',
    '--input-bg': '#ffffff',
    '--input-text': '#212121',
    '--feedback-option-bg': '#f8f9fa',
    '--feedback-option-text': '#212121',
    '--feedback-option-hover-bg': '#e0e0e0',
    '--feedback-option-selected-bg': '#e3f2fd',
    '--feedback-option-selected-text': '#3A9BFF',
    '--feedback-option-outline': '#e0e0e0',
    '--bot-message-text': '#212121',
    '--user-message-text': '#212121',
  ...
  darkMode: {
    '--background': '#121212',
    '--input-container': '#1e1e1e',
    '--bot-response': '#1e1e1e',
    '--user-response': '#2d2d2d',
    ...
    '--feedback-option-selected-bg': '#3A9BFF',
    '--feedback-option-selected-text': '#ffffff',
    '--feedback-option-outline': '#3A9BFF',
  ...
  dot: {
    width: '8px',
    height: '8px',
    backgroundColor: 'var(--typing-indicator-color, #049fd9)',
    borderRadius: '50%',
    margin: '0 2px',
