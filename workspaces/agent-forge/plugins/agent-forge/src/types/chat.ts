...
export interface ChatStorage {
  ...
  executionPlanBuffer?: Record<string, string>; // Store execution plans by message ID
  executionPlanHistory?: Record<string, string[]>; // Store execution plan history by message ID
