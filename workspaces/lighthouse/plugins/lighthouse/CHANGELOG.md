...
- f2e1106: Backstage version bump to v1.52.0

### Patch Changes

- Updated dependencies [f2e1106]
  - @backstage-community/plugin-lighthouse-common@0.21.0
...
- Updated dependencies [950260b]
  - @backstage-community/plugin-lighthouse-common@0.11.0
...
- eef62546ce: Require @backstage-community/plugin-lighthouse-common package where API implementation moved to.

  **BREAKING**: the following types have been moved to @backstage-community/plugin-lighthouse-common:
...
- 6d97d2d6f: The InfoCard variant `'height100'` is deprecated. Use variant `'gridItem'` instead.
  ...
  Changed the InfoCards in '@backstage/plugin-github-actions', '@backstage/plugin-jenkins', '@backstage-community/plugin-lighthouse'
