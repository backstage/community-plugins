...
//
// src/checks.d.ts:15:5 - (ae-undocumented) Missing documentation for "construct".
// src/checks.d.ts:59:5 - (ae-undocumented) Missing documentation for "register".
// src/checks.d.ts:60:5 - (ae-undocumented) Missing documentation for "get".
// src/checks.d.ts:61:5 - (ae-undocumented) Missing documentation for "getAll".
// src/checks.d.ts:62:5 - (ae-undocumented) Missing documentation for "list".
// src/extensionPoints.d.ts:8:1 - (ae-undocumented) Missing documentation for "TechInsightsFactRetrieversExtensionPoint".
// src/extensionPoints.d.ts:9:5 - (ae-undocumented) Missing documentation for "addFactRetrievers".
// src/extensionPoints.d.ts:20:1 - (ae-undocumented) Missing documentation for "TechInsightsFactCheckerFactoryExtensionPoint".
// src/extensionPoints.d.ts:21:5 - (ae-undocumented) Missing documentation for "setFactCheckerFactory".
// src/extensionPoints.d.ts:32:1 - (ae-undocumented) Missing documentation for "TechInsightsFactRetrieverRegistryExtensionPoint".
// src/extensionPoints.d.ts:33:5 - (ae-undocumented) Missing documentation for "setFactRetrieverRegistry".
// src/extensionPoints.d.ts:44:1 - (ae-undocumented) Missing documentation for "TechInsightsPersistenceContextExtensionPoint".
// src/extensionPoints.d.ts:45:5 - (ae-undocumented) Missing documentation for "setPersistenceContext".
// src/facts.d.ts:187:1 - (ae-undocumented) Missing documentation for "FactRetrieverRegistry".
// src/facts.d.ts:188:5 - (ae-undocumented) Missing documentation for "register".
// src/facts.d.ts:189:5 - (ae-undocumented) Missing documentation for "get".
// src/facts.d.ts:190:5 - (ae-undocumented) Missing documentation for "listRetrievers".
// src/facts.d.ts:191:5 - (ae-undocumented) Missing documentation for "listRegistrations".
// src/facts.d.ts:192:5 - (ae-undocumented) Missing documentation for "getSchemas".
// src/persistence.d.ts:40:5 - (ae-undocumented) Missing documentation for "getLatestFactsByIds".
// src/persistence.d.ts:46:5 - (ae-undocumented) Missing documentation for "getEntities".
