...
const LoginModal = ({
  ...
  const meeweeApiBaseUrl = config
    .getConfig('integrations.pluginMeeweeSignUp')
    .getString('signUpUrl');
  ...
  const login = async () => {
    if (validateEmail() && validatePassword()) {
      ...
      try {
        const response = await authnApi.fetchAuthToken(loginParams);
      ...
      >
        ...
        <DialogActions className={classes.dialogActions}>
          ...
          <Typography className={classes.footerText}>
            ...
            <Link underline="hover" href={meeweeApiBaseUrl} target="_blank">
              Sign up now!
            </Link>
          </Typography>
        </DialogActions>
