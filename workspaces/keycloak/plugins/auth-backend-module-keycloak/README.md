...
**Contributors:** see [CONTRIBUTING.md](./CONTRIBUTING.md) for the local Keycloak + auth harness flow, browserless OAuth login smoke (`login.mjs`), and bump-review guidance.
