...
This workspace targets Backstage **1.52.0**, compatible with [Red Hat Developer Hub ~1.11](https://docs.redhat.com/en/documentation/red_hat_developer_hub) (RHDH next). See [DEVELOPMENT.md](./DEVELOPMENT.md#red-hat-developer-hub-compatibility) for the full RHDH compatibility matrix.
