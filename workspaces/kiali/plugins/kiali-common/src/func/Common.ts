...
/**
 * Convert bounds in milliseconds to duration in seconds.
 * @public
 */
...
/**
 * Convert duration in seconds to bounds in milliseconds.
 * @public
 */
...
/**
 * Evaluate time range to get start and end dates.
 * @public
 */
