...
const ExecutionCard = ({ e }: { e: Execution }) => {
  ...
  return (
    <Card className={styles.card}>
        ...
        <table className={styles.table}>
          <tbody>
            <tr>
              ...
              <td className={styles.td}>{e.action.ref}</td>
            </tr>
            <tr>
              <th className={styles.th} scope="row">
                Status
            ...
            <tr>
              ...
              <td className={styles.td}>{Math.round(e.elapsed_seconds)} s</td>
            </tr>
            <tr>
              <th className={styles.th} scope="row">
                Runner
              </th>
              <td className={styles.td}>{e.action.runner_type}</td>
            </tr>
          </tbody>
        </table>
      ...
      <CardFooter>
        <ButtonLink href={st2.getExecutionHistoryUrl(e.id)} target="_blank">
          View in ST2
        </ButtonLink>
      </CardFooter>
    </Card>
