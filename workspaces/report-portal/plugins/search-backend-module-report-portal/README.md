...
```
**Note:** that frequent calls to some ReportPortal API endpoints (e.g., `/projects/list`) can create additional load on the ReportPortal database due to extensive aggregations performed internally.
