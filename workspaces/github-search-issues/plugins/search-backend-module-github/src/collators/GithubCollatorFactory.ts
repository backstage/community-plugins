...
export type GitHubDocumentCollatorFactoryOptions = {
 ...
 * @public
 */
export class GitHubDocumentCollatorFactory implements DocumentCollatorFactory {
  ...
  constructor(options: GitHubDocumentCollatorFactoryOptions) {
  ...
  static fromConfig(
    ...
    return new GitHubDocumentCollatorFactory({
      config: config,
  ...
  private async fetchGitHubDocuments(): Promise<Issue[] | Discussion[]> {
