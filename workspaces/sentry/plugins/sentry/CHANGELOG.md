...
- 03e3f18: Backstage version bump to v1.48.2

## 1.14.0

### Minor Changes

- 4dbcf3e: Backstage version bump to v1.47.2
...
- 2a88e51: Backstage version bump to v1.45.1

## 1.11.0

### Minor Changes

- 500ed79: Backstage version bump to v1.44.0

## 1.10.0

### Minor Changes

- d059a6f: Backstage version bump to v1.43.2

## 1.9.0

### Minor Changes

- bf29c61: Backstage version bump to v1.42.4
...
- a968a3e: Backstage version bump to v1.29.2
...
- 075d3dc5a: The plugin uses the `proxy-backend` instead of a custom `sentry-backend`.
  ...
  -   "@backstage-community/plugin-sentry-backend": "^0.1.3",
