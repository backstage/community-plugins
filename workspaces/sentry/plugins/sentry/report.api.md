...
// @public (undocumented)
export const EntitySentryCard: (props: SentryPageProps) => JSX_2.Element;

// @public (undocumented)
export const EntitySentryContent: (props: SentryPageProps) => JSX_2.Element;
...
// @public (undocumented)
export const sentryApiRef: ApiRef<SentryApi, 'plugin.sentry.service'> & {
...
// @public (undocumented)
export const SentryIssuesWidgetCard: () => JSX_2.Element;
