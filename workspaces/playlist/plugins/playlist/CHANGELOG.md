...
- 61c9269: Backstage version bump to v1.55.1

### Patch Changes

- Updated dependencies [61c9269]
  - @backstage-community/plugin-playlist-common@0.22.0
...
- f019cee: Backstage version bump to v1.47.2

### Patch Changes

- Updated dependencies [f019cee]
  - @backstage-community/plugin-playlist-common@0.14.0
...
- 76ff504: Backstage version bump to v1.45.3

### Patch Changes

- Updated dependencies [76ff504]
  - @backstage-community/plugin-playlist-common@0.12.0
...
- Updated dependencies [e2408fb]
  - @backstage-community/plugin-playlist-common@0.11.0
...
- Updated dependencies [6724458]
  - @backstage-community/plugin-playlist-common@0.10.0
...
- Updated dependencies [720723d]
  - @backstage-community/plugin-playlist-common@0.9.0
...
- Updated dependencies [8fb017f]
  - @backstage-community/plugin-playlist-common@0.8.0
...
- 71ec18e: Ensure 'add entity' drawer title displays the configured value.
...
- f0e2ef3b81: Support being able to define custom composable Playlist index pages
  ...
  **BREAKING** The individual `PlaylistPage` route must now be manually hooked up by making the following change to your setup:
  ...
  ```diff
  -import { PlaylistIndexPage } from '@backstage-community/plugin-playlist';
