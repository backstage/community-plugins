...
data:
  dynamic-plugins.yaml: |
    ...
    plugins:
      ...
      - disabled: false
        package: 'ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-backstage-plugin-mta-backend:pr_1493__0.5.1!backstage-plugin-mta-backend'
      - disabled: false
