...
export const ApplicationDetailsHeader = ({
  ...
  const { identities, isFetching, isError, fetchError, refetch } =
    useFetchIdentities();
      ...
      <Grid item xs={12} md={6}>
        <Paper style={{ padding: '16px', backgroundColor: '#fff3f3' }}>
          ...
          <Typography variant="body1">
            Unable to fetch identity information from the MTA server. This is
            likely because your Backstage client in Keycloak is missing the
            required scopes.
          </Typography>
          <Typography variant="body2" style={{ marginTop: '8px' }}>
            Please ensure a Backstage client is added to your Keycloak realm
            with the necessary scopes (applications:get, identities:get, etc.)
            to make requests against MTA.
          </Typography>
          <Typography variant="body2" style={{ marginTop: '8px' }}>
            See{' '}
            <a
