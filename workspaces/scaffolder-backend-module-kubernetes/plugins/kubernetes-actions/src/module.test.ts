...
describe('scaffolderModuleKubernetesAction', () => {
  it('registers kubernetes:create-namespace via the scaffolder extension point', async () => {
    ...
    await startTestBackend({
      ...
      features: [
        scaffolderModuleKubernetesAction,
        mockServices.discovery.factory(),
      ],
    });

    expect(registeredIds).toEqual(['kubernetes:create-namespace']);
  });
});
