...
To enable the PipelineRun list in the CI/CD tab (or any other tab) on the entity view page, add the following snippet in the packages/app/src/components/catalog/EntityPage.tsx.
...
The **CI/CD** tab displays the list of Pipeline Runs from your CI's based on the component annotations.
