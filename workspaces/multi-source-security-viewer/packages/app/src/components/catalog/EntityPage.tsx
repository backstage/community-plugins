...
const securityContent = (
  <EntitySwitch>
    ...
    <EntitySwitch.Case>
      <EmptyState
        title="No security information available for this entity"
        missing="info"
        description="You need to add an annotation to your component if you want to enable security information for it. You can read more about annotations in Backstage by clicking the button below."
        action={
          <Button
            variant="contained"
            color="primary"
