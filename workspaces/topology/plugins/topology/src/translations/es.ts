...
const topologyTranslationEs = createTranslationMessages({
  ...
  messages: {
    ...
    'details.noOwner': 'Sin propietario asignado',
    'details.notAvailable': 'No disponible',
    'details.notConfigured': 'No configurado',
    'details.updateStrategy': 'Estrategia de actualización',
    'details.maxUnavailable': 'Máx. instancias no disponibles',
    'details.maxSurge': 'Máx. aumento',
    'details.progressDeadlineSeconds': 'Plazo de progreso (segundos)',
    'details.minReadySeconds': 'Tiempo mínimo de preparación (segundos)',
