...
const topologyTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'sideBar.persistentVolumeClaims': 'Revendications de volume persistant',
    'workload.deployment': 'Déploiement',
    'workload.daemonSet': 'DaemonSet',
    'workload.statefulSet': 'StatefulSet',
    'workload.job': 'Tâche',
    'workload.cronJob': 'Tâche Cron',
    'workload.pod': 'Pod',
    'workload.virtualMachine': 'Machine virtuelle',
    ...
    'common.frequently': 'Fréquemment',
    'common.occasionally': 'Occasionnellement',
    'common.daily': 'Quotidien',
    'common.weekly': 'Hebdomadaire',
    'common.monthly': 'Mensuel',
    'common.yearly': 'Annuel',
    'common.hourly': 'Horaire',
    'common.minutely': 'Par minute',
    ...
    'common.will': 'va',
    'common.would': 'ferait',
    'common.could': 'pourrait',
    'common.should': 'devrait',
    'common.may': 'peut',
    'common.might': 'pourrait',
    'common.can': 'peut',
    'common.cannot': 'ne peut pas',
    'common.must': 'doit',
    'common.shall': 'doit',
    'common.do': 'faire',
    'common.does': 'fait',
