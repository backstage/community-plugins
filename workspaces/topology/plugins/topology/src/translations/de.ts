...
const topologyTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'details.noLabels': 'Keine Labels',
    'details.noAnnotations': 'Keine Annotationen',
    'details.noOwner': 'Kein Besitzer',
    'details.notAvailable': 'Nicht verfügbar',
    'details.notConfigured': 'Nicht konfiguriert',
    'details.updateStrategy': 'Aktualisierungsstrategie',
    'details.maxUnavailable': 'Max. nicht verfügbare Instanzen',
    'details.maxSurge': 'Max. Überbelegung',
    'details.progressDeadlineSeconds': 'Fortschrittsfrist (Sekunden)',
    'details.minReadySeconds': 'Min. Bereitschaftszeit (Sekunden)',
