...
import { topologyMessages } from '../../src/translations/ref.js';
import topologyTranslationDe from '../../src/translations/de.js';
...
function transform(messages: FlatMessages): TopologyMessages {
