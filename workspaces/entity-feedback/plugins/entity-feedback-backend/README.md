...
Also this plugin use Backstage Notifications to notify the owners about feedback, to install
it you can use the [Backstage implementation guide](https://backstage.io/docs/notifications/).
