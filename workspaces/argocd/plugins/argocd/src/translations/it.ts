...
const argocdTranslationIt = createTranslationMessages({
  ...
  messages: {
    ...
    'common.permissionAlert.alertText':
      "Per visualizzare il plugin argocd, contatta il tuo amministratore affinché ti assegni l'autorizzazione argocd.view.read.",
    ...
    'deploymentLifecycle.sidebar.resources.resource.deploymentMetadata.metadataItemWithTooltip.tooltipText':
      "Queste sono le immagini di tutti i deployment nell'applicazione ArgoCD.",
    ...
    'deploymentLifecycle.deploymentLifecycle.subtitle':
      'Esamina i componenti/sistemi di cui è stato effettuato il deployment nel namespace utilizzando il plugin ArgoCD',
    ...
    'deploymentLifecycle.deploymentLifecycleCard.tooltipText':
      "L'SHA del commit mostrato di seguito è l'ultimo commit della prima origine dell'applicazione definita.",
    ...
    'deploymentLifecycle.deploymentLifecycleCard.resourcesDeployed':
      'risorse di cui è stato eseguito il deployment',
