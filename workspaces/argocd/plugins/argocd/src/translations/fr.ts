...
const argocdTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'common.permissionAlert.alertText':
      "Pour consulter le plugin argocd, contactez votre administrateur afin qu'il vous accorde l'autorisation argocd.view.read.",
    ...
    'deploymentLifecycle.deploymentLifecycle.subtitle':
      "Examinez les composants/systèmes déployés dans l'espace de noms à l'aide du plugin ArgoCD",
    ...
    'deploymentLifecycle.deploymentLifecycleCard.tooltipText':
      "Le SHA de validation affiché ci-dessous correspond à la dernière instance de validation de la première source d'application définie.",
