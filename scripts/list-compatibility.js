  ...
  if (save) {
    await fs.writeFile(
      ...
      (
        ...
        /<!-- This table is automatically generated by the list-compatibility script -->[\s\S]*<!-- end of table -->/,
        `<!-- This table is automatically generated by the list-compatibility script -->

${arrayToTable(workspaceReports)}
