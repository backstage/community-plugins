...
const REPORT_PATH = resolve(__dirname, '..', 'docs', 'README.md');
  ...
  if (save) {
    await fs.writeFile(
      ...
      (
        ...
        /<!-- This table is automatically generated by the list-workspaces-for-docs script -->[\s\S]*<!-- end of table -->/,
        `<!-- This table is automatically generated by the list-workspaces-for-docs script -->

${arrayToTable(backendFeatureReports)}
