...
class CommunityPluginsMigrationAnalyzer {
  ...
  generateMarkdown() {
    ...
    md.push('');
    md.push(
      '_This report is automatically generated by the [Community Plugins MUI to BUI Migration Analytics Script](../../scripts/mui-to-bui.js)_',
    );
    md.push('');
...
// Export for testing
export { CommunityPluginsMigrationAnalyzer, CONFIG };
